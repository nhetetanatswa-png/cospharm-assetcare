...
if (!workerModule.default || typeof workerModule.default.fetch !== "function") {
  throw new Error("The built AssetCare Worker does not expose default.fetch().");
}
...
const response = await workerModule.default.fetch(
  new Request("https://cospharm-assetcare.pages.dev/"),
  environment,
  context,
);
...
if (!html.startsWith("<!DOCTYPE html>") || !html.includes("Cospharm AssetCare")) {
